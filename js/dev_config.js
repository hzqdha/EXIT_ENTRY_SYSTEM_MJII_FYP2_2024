$(document).ready(function(){
	...
	$(document).on('click', '.dev_uid_up', function(){
		...
		bootbox.confirm({
			message: "<span style='color: black;'>Do you really want to Update this Device?</span>",
	...
	$(document).on('click', '.dev_del', function(){
		...
		bootbox.confirm({
			message: "<span style='color: black;'>Do you really want to delete this Department?</span>",
			callback: function(result) {
				if(result){
				     // AJAX Request
				     $.ajax({
	...
	$(document).on('click', '.mode_sel', function(){
		...
		bootbox.confirm({
			message: "<span style='color: black;'>Do you really want to change this Device Mode?</span>",
			callback: function(result) {
				if(result){
				     // AJAX Request
				     $.ajax({
