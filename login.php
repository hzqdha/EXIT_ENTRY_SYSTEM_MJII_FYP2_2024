...
<head>
  ...
  href="icons/logoMJII.png">
    ...
    <style>
      ...
      h1.slideInDown.animated {
        color: white; /* Tukar warna teks kepada putih */
      }
    </style>
</head>
<body>
<video autoplay muted loop id="bgVideo">
  <source src="icons/FrontPage2.mov" type="video/mp4"> <!-- Tukar kepada MP4 jika MOV tidak disokong -->
